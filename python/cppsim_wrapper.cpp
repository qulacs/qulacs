...
PYBIND11_MODULE(qulacs, m) {
    ...
    py::class_<QuantumCircuit>(m, "QuantumCircuit")
		...
		.def("add_gate_copy", (void (QuantumCircuit::*)(const QuantumGateBase&))&QuantumCircuit::add_gate_copy)
		.def("add_gate_copy", (void (QuantumCircuit::*)(const QuantumGateBase&, unsigned int))&QuantumCircuit::add_gate_copy)
