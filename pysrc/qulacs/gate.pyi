...
def Pauli(index_list: List[int], pauli_ids: List[int]) -> ClsPauliGate: ...
def PauliRotation(index_list: List[int], pauli_ids: List[int], angle: float) -> ClsPauliRotationGate: ...
...
def ReversibleBoolean(index_list: List[int], func: Callable[[int,int],int]) -> ClsReversibleBooleanGate: ...
