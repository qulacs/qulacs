...
def NoisyEvolution(hamiltonian: qulacs_core.GeneralQuantumOperator, c_ops: List[qulacs_core.GeneralQuantumOperator], time: float, dt: float) -> qulacs_core.QuantumGateBase: ...
