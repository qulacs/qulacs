...
QuantumCircuit::QuantumCircuit(const QuantumCircuit &obj) : qubit_count(_qubit_count), gate_list(_gate_list) {
	_gate_list.clear();
...
QuantumCircuit::QuantumCircuit(UINT qubit_count_) : qubit_count(_qubit_count), gate_list(_gate_list) {
	this->_qubit_count = qubit_count_;
}

QuantumCircuit::QuantumCircuit(std::string qasm_path, std::string qasm_loader_script_path) : qubit_count(_qubit_count), gate_list(_gate_list) {
