...
void single_qubit_control_single_qubit_dense_matrix_gate_unroll(UINT control_qubit_index, UINT control_value, UINT target_qubit_index, const CTYPE matrix[4], CTYPE *state, ITYPE dim);
void single_qubit_control_single_qubit_dense_matrix_gate_simd(UINT control_qubit_index, UINT control_value, UINT target_qubit_index, const CTYPE matrix[4], CTYPE *state, ITYPE dim);
void single_qubit_control_single_qubit_dense_matrix_gate_parallel(UINT control_qubit_index, UINT control_value, UINT target_qubit_index, const CTYPE matrix[4], CTYPE *state, ITYPE dim);
...
void single_qubit_control_single_qubit_dense_matrix_gate(UINT control_qubit_index, UINT control_value, UINT target_qubit_index, const CTYPE matrix[4], CTYPE *state, ITYPE dim) {
	...
	//single_qubit_control_single_qubit_dense_matrix_gate_unroll(control_qubit_index, control_value, target_qubit_index, matrix, state, dim);
	//single_qubit_control_single_qubit_dense_matrix_gate_simd(control_qubit_index, control_value, target_qubit_index, matrix, state, dim);
	//single_qubit_control_single_qubit_dense_matrix_gate_parallel(control_qubit_index, control_value, target_qubit_index, matrix, state, dim);
