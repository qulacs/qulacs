...
INSTANTIATE_TEST_CASE_P(SinglePauli, PauliOperatorMultiplyTest,
    testing::Values(PauliTestParam(PauliOperator("X 0", 2.0),
                        PauliOperator("X 0", 2.0), PauliOperator("I 0", 4.0)),
        PauliTestParam(PauliOperator("X 0", 2.0), PauliOperator("Y 0", 2.0),
            PauliOperator("Z 0", 4.0i)),
        PauliTestParam(PauliOperator("X 0", 2.0), PauliOperator("Z 0", 2.0),
            PauliOperator("Y 0", -4.0i)),
        PauliTestParam(PauliOperator("Y 0", 2.0), PauliOperator("X 0", 2.0),
            PauliOperator("Z 0", -4.0i)),
        PauliTestParam(PauliOperator("Y 0", 2.0), PauliOperator("Y 0", 2.0),
            PauliOperator("I 0", 4.0)),
        PauliTestParam(PauliOperator("Y 0", 2.0), PauliOperator("Z 0", 2.0),
            PauliOperator("X 0", 4.0i)),
        PauliTestParam(PauliOperator("Z 0", 2.0), PauliOperator("X 0", 2.0),
            PauliOperator("Y 0", 4.0i)),
        PauliTestParam(PauliOperator("Z 0", 2.0), PauliOperator("Y 0", 2.0),
            PauliOperator("X 0", -4.0i)),
        PauliTestParam(PauliOperator("Z 0", 2.0), PauliOperator("Z 0", 2.0),
            PauliOperator("I 0", 4.0))));
