...
TEST(UpdateTest, SingleDenseMatrixTest) {
	void (*func)(UINT, const CPPCTYPE *, void *, ITYPE, void *, UINT) = &single_qubit_dense_matrix_gate_host;
...
TEST(UpdateTest, TwoQubitDenseMatrixTest) {
	void (*func)(UINT, UINT, const CPPCTYPE *, void *, ITYPE, void *, UINT) = &double_qubit_dense_matrix_gate_host;
...
void test_three_dense_matrix_gate(std::function<void(UINT, UINT, UINT, const CPPCTYPE *, void *, ITYPE, void *, UINT)> func) {
	...
	for (int idx = 0; idx < ngpus; ++idx) {
		...
		for (UINT rep = 0; rep < max_repeat; ++rep) {
			...
			test_state =
				get_expanded_eigen_matrix_with_identity(targets[2], U3, n) * get_expanded_eigen_matrix_with_identity(targets[1], U2, n) * get_expanded_eigen_matrix_with_identity(targets[0], U1, n) * test_state;
...
TEST(UpdateTest, ThreeQubitDenseMatrixTest) {
	void (*func)(UINT, UINT, UINT, const CPPCTYPE *, void *, ITYPE, void *, UINT) = &triple_qubit_dense_matrix_gate_host;
...
void test_quad_dense_matrix_gate(std::function<void(const UINT *, const CPPCTYPE *, void *, ITYPE, void *, UINT)> func) {
	...
	for (int idx = 0; idx < ngpus; ++idx) {
		...
		for (UINT rep = 0; rep < max_repeat; ++rep) {
			...
			test_state =
				get_expanded_eigen_matrix_with_identity(targets[3], U4, n) * get_expanded_eigen_matrix_with_identity(targets[2], U3, n) * get_expanded_eigen_matrix_with_identity(targets[1], U2, n) * get_expanded_eigen_matrix_with_identity(targets[0], U1, n) * test_state;
...
TEST(UpdateTest, FourQubitDenseMatrixTest) {
	void (*func)(const UINT *, const CPPCTYPE *, void *, ITYPE, void *, UINT) = &quad_qubit_dense_matrix_gate_host;
...
void test_penta_dense_matrix_gate(std::function<void(const UINT *, const CPPCTYPE *, void *, ITYPE, void *, UINT)> func) {
	...
	for (int idx = 0; idx < ngpus; ++idx) {
		...
		for (UINT rep = 0; rep < max_repeat; ++rep) {
			...
			test_state =
				get_expanded_eigen_matrix_with_identity(targets[4], U5, n) * get_expanded_eigen_matrix_with_identity(targets[3], U4, n) * get_expanded_eigen_matrix_with_identity(targets[2], U3, n) * get_expanded_eigen_matrix_with_identity(targets[1], U2, n) * get_expanded_eigen_matrix_with_identity(targets[0], U1, n) * test_state;
			func(targets, (CPPCTYPE *)Umerge.data(), state, dim, stream_ptr, idx);
...
TEST(UpdateTest, FiveQubitDenseMatrixTest) {
	void (*func)(const UINT *, const CPPCTYPE *, void *, ITYPE, void *, UINT) = &penta_qubit_dense_matrix_gate_host;
...
void test_general_dense_matrix_gate(std::function<void(const UINT *, UINT, const CPPCTYPE *, void *, ITYPE, void *, UINT)> func) {
	...
	for (int idx = 0; idx < ngpus; ++idx) {
		...
		for (UINT rep = 0; rep < max_repeat; ++rep) {
			...
			test_state =
				get_expanded_eigen_matrix_with_identity(targets[5], U6, n) * get_expanded_eigen_matrix_with_identity(targets[4], U5, n) * get_expanded_eigen_matrix_with_identity(targets[3], U4, n) * get_expanded_eigen_matrix_with_identity(targets[2], U3, n) * get_expanded_eigen_matrix_with_identity(targets[1], U2, n) * get_expanded_eigen_matrix_with_identity(targets[0], U1, n) * test_state;
...
TEST(UpdateTest, SixQubitDenseMatrixTest) {
	void (*func)(const UINT *, UINT, const CPPCTYPE *, void *, ITYPE, void *, UINT) = &multi_qubit_dense_matrix_gate_host;
