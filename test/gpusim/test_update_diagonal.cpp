...
TEST(UpdateTest, SingleDiagonalMatrixTest) {
	void (*func)(UINT, const CPPCTYPE *, void *, ITYPE, void *, UINT) = &single_qubit_diagonal_matrix_gate_host;
...
TEST(UpdateTest, SinglePhaseGateTest) {
	void (*func)(UINT, CPPCTYPE, void *, ITYPE, void *, UINT) = &single_qubit_phase_gate_host;
